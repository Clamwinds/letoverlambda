...
function BuildContext(options, readFileCache) {
    ...
    if (options) {
        assert.strictEqual(typeof options === "undefined" ? "undefined" : _typeof(options), "object");
    } else {
        options = {};
    }
...
BCp.setCacheDirectory = function (dir) {
    if (!dir) {
        // Disable the cache directory.
            ...
            assert.strictEqual(typeof dir === "undefined" ? "undefined" : _typeof(dir), "string");
        }
...
function PreferredFileExtension(ext) {
    assert.strictEqual(typeof ext === "undefined" ? "undefined" : _typeof(ext), "string");
