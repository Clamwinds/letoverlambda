...
function ModuleReader(context, resolvers, processors) {
    ...
    function hashCallbacks(salt) {
        ...
        cbs.forEach(function (cb) {
            assert.strictEqual(typeof cb === "undefined" ? "undefined" : _typeof(cb), "function");
            hash.update(cb + "\0");
        });
    ...
    if (context.relativize && !context.ignoreDependencies) procArgs.push(require("./relative").getProcessor(self));
...
ModuleReader.prototype = {
    ...
    readModuleP: util.cachedMethod(function (id) {
        ...
        return reader.getSourceP(id).then(function (source) {
            ...
            assert.strictEqual(typeof source === "undefined" ? "undefined" : _typeof(source), "string");
    ...
    processOutputP: function processOutputP(id, hash, source) {
        var reader = this;
        ...
        function buildP() {
            ...
            return promise.then(function (output) {
                if (typeof output === "string") {
                    ...
                    assert.strictEqual(typeof output === "undefined" ? "undefined" : _typeof(output), "object");
                }
    ...
    readMultiP: function readMultiP(ids) {
        var reader = this;

        return Q(ids).all().then(function (ids) {
            if (ids.length === 0) return ids; // Shortcut.
...
Module.prototype = {
    getRequiredP: function getRequiredP() {
        return this.reader.readMultiP(this.deps);
    },

    writeVersionP: function writeVersionP(outputDir) {
        var id = this.id;
        var hash = this.hash;
