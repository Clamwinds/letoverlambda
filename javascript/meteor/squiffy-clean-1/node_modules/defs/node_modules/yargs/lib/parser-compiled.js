...
module.exports = function (args, opts, y18n) {
  ...
  var __ = y18n.__;
  var error = null;
  var flags = { arrays: {}, bools: {}, strings: {}, counts: {}, normalize: {}, configs: {}, defaulted: {} };[].concat(opts['array']).filter(Boolean).forEach(function (key) {
  ...
  function setArg(key, val) {
    ...
    setKey(argv, splitKey, value);(aliases[splitKey[0]] || []).forEach(function (x) {
      x = x.split('.');
