  ...
  self.help = function () {
    ...
    if (keys.length) {
      ...
      keys.forEach(function (key) {
        ...
        ui.span({ text: kswitch, padding: [0, 2, 0, 2], width: maxWidth(switches) + 4 }, desc);
    ...
    if (examples.length) {
      ...
      examples.forEach(function (example) {
        ui.div({ text: example[0], padding: [0, 2, 0, 2], width: maxWidth(examples) + 4 }, example[1]);
      });
...
//# sourceMappingURL=usage-compiled.js.map