    ...
    var mixins = /** @lends _ */{
        ...
        deepIn: function (collection, propertyPath) {
            ...
            for (var i = 0; i < properties.length; i++) {
                ...
                if (_.has(collection, property) || _.isObject(collection) && property in collection) {
        ...
        deepEscapePropertyName: function (propertyName) {
            return propertyName.replace(/\\/g, '\\\\').replace(/(\.|\[|\])/g, '\\$1');
        },
        /**
...
//# sourceMappingURL=lodash-deep-compiled.js.map