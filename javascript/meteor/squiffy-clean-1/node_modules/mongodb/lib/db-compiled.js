...
var debugFields = ['authSource', 'w', 'wtimeout', 'j', 'native_parser', 'forceServerObjectId', 'serializeFunctions', 'raw', 'promoteLongs', 'bufferMaxEntries', 'numberOfRetries', 'retryMiliSeconds', 'readPreference', 'pkFactory'];
...
var Db = function Db(databaseName, topology, options) {
  ...
  Object.defineProperty(this, 'slaveOk', {
    enumerable: true,
    get: function get() {
      if (self.s.options.readPreference != null && (self.s.options.readPreference != 'primary' || self.s.options.readPreference.mode != 'primary')) {
        return true;
      }
      return false;
    }
...
var createCollection = function createCollection(self, name, options, callback) {
  ...
  self.listCollections({ name: name }).toArray(function (err, collections) {
    ...
    for (var n in options) {
      if (options[n] != null && typeof options[n] != 'function') cmd[n] = options[n];
    }
...
var getReadPreference = function getReadPreference(options, db) {
