...
var Mongos = function Mongos(servers, options) {
  ...
  if (options.socketOptions) {
    ...
    if (options.socketOptions.socketTimeoutMS) finalOptions.socketTimeout = options.socketOptions.socketTimeoutMS;
  }
...
Mongos.prototype.connect = function (db, _options, callback) {
  ...
  // Error handler
  var connectErrorHandler = function connectErrorHandler(event) {
    return function (err) {
  ...
  // Error handler
  var reconnectHandler = function reconnectHandler(err) {
    self.emit('reconnect');
