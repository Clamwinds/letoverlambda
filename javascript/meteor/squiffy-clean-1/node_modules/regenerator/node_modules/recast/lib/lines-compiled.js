...
function countSpaces(spaces, tabWidth) {
    ...
    for (var i = 0; i < len; ++i) {
        switch (spaces.charCodeAt(i)) {
            case 9:
                // '\t'
                assert.strictEqual(typeof tabWidth === "undefined" ? "undefined" : _typeof(tabWidth), "number");
...
Lp.bootstrapCharAt = function (pos) {
    assert.strictEqual(typeof pos === "undefined" ? "undefined" : _typeof(pos), "object");
    assert.strictEqual(_typeof(pos.line), "number");
    assert.strictEqual(_typeof(pos.column), "number");
...
//# sourceMappingURL=lines-compiled.js.map