...
function Printer(originalOptions) {
    ...
    function maybeReprint(path) {
        ...
        if (reprinter) return maybeAddParens(path, reprinter(print));
...
function genericPrintNoParens(path, options, print) {
    ...
    switch (n.type) {
        ...
        case "ArrayPattern":
            ...
            path.each(function (elemPath) {
                ...
                if (!elem) {
                    ...
                    parts.push(lines);
                    if (i < len - 1 || !oneLine && options.trailingComma) parts.push(",");
        ...
        case "BooleanLiteralTypeAnnotation":
            assert.strictEqual(_typeof(n.value), "boolean");
            return fromString("" + n.value, options);
...
//# sourceMappingURL=printer-compiled.js.map