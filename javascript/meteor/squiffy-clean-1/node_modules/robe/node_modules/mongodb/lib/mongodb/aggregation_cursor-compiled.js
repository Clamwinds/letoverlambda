...
var AggregationCursor = function (collection, serverCapabilities, options) {
	...
	this.explain = function (callback) {
		if (typeof callback != 'function') throw utils.toError("AggregationCursor explain requires a callback function");
	...
	this.get = function (callback) {
		if (typeof callback != 'function') throw utils.toError("AggregationCursor get requires a callback function");
	...
	this.getOne = function (callback) {
		if (typeof callback != 'function') throw utils.toError("AggregationCursor getOne requires a callback function");
		// Set the limit to 1
		pipe.push({ $limit: 1 });
	...
	this.each = function (callback) {
		...
		if (!connection) connection = collection.db.serverConfig.checkoutReader(_options.readPreference);
	...
	this.next = function (callback) {
		if (typeof callback != 'function') throw utils.toError("AggregationCursor next requires a callback function");
	...
	this.close = function (callback) {
		if (typeof callback != 'function') throw utils.toError("AggregationCursor close requires a callback function");
...
//# sourceMappingURL=aggregation_cursor-compiled.js.map