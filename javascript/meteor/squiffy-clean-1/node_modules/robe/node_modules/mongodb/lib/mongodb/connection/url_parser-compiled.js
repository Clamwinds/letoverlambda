...
exports.parse = function (url, options) {
  ...
  if (url.indexOf("mongodb://") != 0) throw Error("URL must be in the format mongodb://user:pass@host:port/dbname");
  ...
  urlOptions.forEach(function (opt) {
    ...
    switch (name) {
      ...
      case 'authMechanism':
        ...
        if (value != 'GSSAPI' && value != 'MONGODB-X509' && value != 'SCRAM-SHA-1' && value != 'MONGODB-CR' && value != 'PLAIN') throw new Error("only GSSAPI, PLAIN, MONGODB-X509, SCRAM-SHA-1 or MONGODB-CR is supported by authMechanism");
...
//# sourceMappingURL=url_parser-compiled.js.map