...
Cursor.prototype.sort = function (keyOrList, direction, callback) {
  ...
  if (typeof direction === "function") {
    callback = direction;direction = null;
  }
...
Cursor.prototype.setReadPreference = function (readPreference, tags, callback) {
  ...
  } else if (_mode != null && _mode != 'primary' && _mode != 'secondaryOnly' && _mode != 'secondary' && _mode != 'nearest' && _mode != 'primaryPreferred' && _mode != 'secondaryPreferred') {
...
var generateQueryCommand = function (self) {
  ...
  if (readPreference == ReadPreference.PRIMARY_PREFERRED || readPreference == ReadPreference.SECONDARY || readPreference == ReadPreference.SECONDARY_PREFERRED || readPreference == ReadPreference.NEAREST) {
  ...
  if (self.sortValue != null || self.explainValue != null || self.hint != null || self.snapshot != null || self.returnKey != null || self.maxScan != null || self.min != null || self.max != null || self.showDiskLoc != null || self.comment != null || typeof self.maxTimeMSValue == 'number') {
    ...
    if (typeof self.maxTimeMSValue == 'number' && self.collectionName.indexOf('.$cmd') != -1) {
      specialSelector['maxTimeMS'] = self.maxTimeMSValue;
    } else if (typeof self.maxTimeMSValue == 'number' && self.collectionName.indexOf('.$cmd') == -1) {
      specialSelector['$maxTimeMS'] = self.maxTimeMSValue;
    }
...
//# sourceMappingURL=cursor-compiled.js.map