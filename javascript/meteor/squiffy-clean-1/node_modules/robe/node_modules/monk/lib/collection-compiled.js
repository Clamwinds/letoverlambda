...
Collection.prototype.id = Collection.prototype.oid = function (str) {
...
Collection.prototype.index = Collection.prototype.ensureIndex = function (fields, opts, fn) {
...
Collection.prototype.findAndModify = function (query, update, opts, fn) {
  ...
  promise.query = query;
  this.col.findAndModify(query.query, [], query.update, this.opts(opts), promise.resolve);
