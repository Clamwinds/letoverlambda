...
var mergeLegacyResults = function (_ordered, _op, _batch, _results, _result, _index) {
  ...
  if ((_result.errmsg || _result.err || _result instanceof Error) && _result.wtimeout != true) {
    ...
    if (_result.wnote || _result.jnote == "journaling not enabled on this server" || _result.err == "norepl" || _result.code == 16544 || _result.code == 13) {
      _results.ok = 0;
    ...
    if (_ordered == true && _result.jnote == null && _result.wnote == null && _result.wtimeout == null) {
      return false;
    }
