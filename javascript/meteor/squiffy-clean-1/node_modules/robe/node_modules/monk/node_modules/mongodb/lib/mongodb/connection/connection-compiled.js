...
Connection.prototype.isCompatible = function () {
  ...
  if (this.serverCapabilities.minWireVersion == 0 && this.serverCapabilities.maxWireVersion == 0) return true;

  // Check if we overlap
  if (this.serverCapabilities.minWireVersion >= this.minWireVersion && this.serverCapabilities.maxWireVersion <= this.maxWireVersion) return true;
    ...
    if (Array.isArray(command)) {
      for (var i = 0; i < command.length; i++) {
        try {
          ...
          if (this.logger != null && this.logger.doDebug) this.logger.debug("writing command to mongodb", { binary: binaryCommand, json: command[i] });
      ...
      try {
        ...
        if (this.logger != null && this.logger.doDebug) this.logger.debug("writing command to mongodb", { binary: binaryCommand, json: command });
...
//# sourceMappingURL=connection-compiled.js.map