  ...
  return (function (e) {
    ...
    function t(e) {
      ...
      var n = i.getArg(e, "generated"),
          ...
          o = i.getArg(e, "name", null);this._skipValidation || this._validateMapping(n, r, t, o), null == t || this._sources.has(t) || this._sources.add(t), null == o || this._names.has(o) || this._names.add(o), this._mappings.add({ generatedLine: n.line, generatedColumn: n.column, originalLine: null != r && r.line, originalColumn: null != r && r.column, source: t, name: o });
    }, t.prototype.setSourceContent = function (e, n) {
      var r = e;null != this._sourceRoot && (r = i.relative(this._sourceRoot, r)), null != n ? (this._sourcesContents || (this._sourcesContents = {}), this._sourcesContents[i.toSetString(r)] = n) : this._sourcesContents && (delete this._sourcesContents[i.toSetString(r)], 0 === Object.keys(this._sourcesContents).length && (this._sourcesContents = null));
      ...
      for (var e, n, r, t = 0, s = 1, a = 0, u = 0, l = 0, c = 0, g = "", p = this._mappings.toArray(), h = 0, f = p.length; f > h; h++) {
        if ((e = p[h], e.generatedLine !== s)) for (t = 0; e.generatedLine !== s;) {
          g += ";", s++;
        } else if (h > 0) {
          if (!i.compareByGeneratedPositionsInflated(e, p[h - 1])) continue;g += ",";
    ...
    function r(e, n, r) {
      ...
      var n = e.match(f);return n ? { scheme: n[1], auth: n[2], host: n[3], port: n[4], path: n[5] } : null;
    }function o(e) {
      ...
      "" === e && (e = "."), "" === n && (n = ".");var r = t(n),
          s = t(e);if ((s && (e = s.path || "/"), r && !r.scheme)) return s && (r.scheme = s.scheme), o(r);if (r || n.match(d)) return n;if (s && !s.host && !s.path) return s.host = n, o(s);var a = "/" === n.charAt(0) ? n : i(e.replace(/\/+$/, "") + "/" + n);return s ? (s.path = a, o(s)) : a;
    }function a(e, n) {
      ...
      var r = e.generatedLine - n.generatedLine;return 0 !== r ? r : (r = e.generatedColumn - n.generatedColumn, 0 !== r ? r : (r = p(e.source, n.source), 0 !== r ? r : (r = e.originalLine - n.originalLine, 0 !== r ? r : (r = e.originalColumn - n.originalColumn, 0 !== r ? r : p(e.name, n.name)))));
    }n.getArg = r;var f = /^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.]*)(?::(\d+))?(\S*)$/,
        d = /^data:.+\,.+$/;n.urlParse = t, n.urlGenerate = o, n.normalize = i, n.join = s, n.isAbsolute = function (e) {
    ...
    function t() {
    ...
    }var o = r(4);t.fromArray = function (e, n) {
      for (var r = new t(), o = 0, i = e.length; i > o; o++) {
        r.add(e[o], n);
      }return r;
      ...
      var r = o.toSetString(e),
          ...
          i = this._array.length;(!t || n) && this._array.push(e), t || (this._set[r] = i);
    }, t.prototype.has = function (e) {
      var n = o.toSetString(e);return this._set.hasOwnProperty(n);
    }, t.prototype.indexOf = function (e) {
      var n = o.toSetString(e);if (this._set.hasOwnProperty(n)) return this._set[n];throw new Error('"' + e + '" is not in the set.');
    ...
    function t(e) {
      ...
      var n = e;"string" == typeof e && (n = JSON.parse(e.replace(/^\)\]\}'/, "")));var r = a.getArg(n, "version"),
          ...
          c = a.getArg(n, "file", null);if (r != this._version) throw new Error("Unsupported version: " + r);t = t.map(a.normalize).map(function (e) {
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, A = [], S = []; _ > v;) {
        if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
          for (r = new i(), r.generatedLine = l, s = v; _ > s && !this._charIsMappingSeparator(e, s); s++) {}if ((t = e.slice(v, s), o = y[t])) v += t.length;else {
            for (o = []; s > v;) {
    ...
    function r(e, t, o, i, s, a) {
      ...
      if (0 === t.length) return -1;var s = r(-1, t.length, e, t, o, i || n.GREATEST_LOWER_BOUND);if (0 > s) return -1;for (; s - 1 >= 0 && 0 === o(t[s], t[s - 1], !0);) {
        --s;
      }return s;
    };
  }, function (e, n) {
    function r(e, n, r) {
      ...
      if (s > i) {
        var a = t(i, s),
            u = i - 1;r(e, a, s);for (var l = e[s], c = i; s > c; c++) {
    ...
    function t(e, n, r, t, o) {
      ...
      for (var n, r = 0, t = this.children.length; t > r; r++) {
      ...
      }for (var t = Object.keys(this.sourceContents), n = 0, r = t.length; r > n; n++) {
      ...
      var n = { code: "", line: 1, column: 0 },
        ...
        n.code += e, null !== o.source && null !== o.line && null !== o.column ? ((i !== o.source || s !== o.line || u !== o.column || l !== o.name) && r.addMapping({ source: o.source, original: { line: o.line, column: o.column }, generated: { line: n.line, column: n.column }, name: o.name }), i = o.source, s = o.line, u = o.column, l = o.name, t = !0) : t && (r.addMapping({ generated: { line: n.line, column: n.column } }), i = null, t = !1);for (var c = 0, g = e.length; g > c; c++) {
...
//# sourceMappingURL=source-map.min-compiled.js.map