...
<html lang="en">
<head>
    <title>Code coverage report for node-tsheets-client/lib/tsheets-service.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-tsheets-client/lib/tsheets-service.js</span></h1>
    <h2>
        
        Statements: <span class="metric">88.89% <small>(32 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">node-tsheets-client/lib/</a> &#187; tsheets-service.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    setImmediate(callback, e);</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (valid_params.page) {
...
<span class="skip-if-branch" title="else path not taken" >E</span>if (process.env.NODE_ENV === 'test') {
  /** @type Object */
