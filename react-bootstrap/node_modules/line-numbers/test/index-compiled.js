...
suite("lineNumbers", function () {
  ...
  test("is a function", function () {
    assert.equal(typeof lineNumbers === "undefined" ? "undefined" : _typeof(lineNumbers), "function");
  });
  ...
  test("options", function () {
    assert.equal(lineNumbers(sumJS.join("\n"), {
      ...
      transform: function transform(params) {
        if (params.number === 13) {
          params.line = params.line + "\n" + params.before + Array(params.width + 1).join(" ") + params.after + Array(params.line.indexOf("(") + 1).join(" ") + "^";
          params.before = params.before.replace(/^./, ">");
        }
      }
    }), ["  05: /**", "  06:  * Sums two numbers.", "  07:  *", "  08:  * @param a Number", "  09:  * @param b Number", "  10:  * @returns Number", "  11:  */", "  12: ", "> 13: function sum(a, b) {", "    :             ^", "  14:   return a + b", "  15: }"].join("\n"));
  });
