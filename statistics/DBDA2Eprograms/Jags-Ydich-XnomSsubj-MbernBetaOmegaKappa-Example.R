...
#------------------------------------------------------------------------------- 
# Read The data file:source()
myData = read.csv("/home/lucien/code/statistics/DBDA2Eprograms/TherapeuticTouchData.csv")
...
source("/home/lucien/code/statistics/DBDA2Eprograms/Jags-Ydich-XnomSsubj-MbernBetaOmegaKappa.R")
#source("/home/lucien/code/statistics/DBDA2Eprograms/TherapeuticTouchData.csv")
#------------------------------------------------------------------------------- 
